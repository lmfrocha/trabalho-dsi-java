package com.puc.dsiapi.exceptionhandler;
...
@ControllerAdvice //Anotacao que monitora toda a aplicacao
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler { //Extende as mensagens
